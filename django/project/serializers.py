...
class ProjectPublishedSerializer(serializers.Serializer):
    ...
    unicef_leading_sector = serializers.IntegerField()
    ...
    def to_representation(self, instance):
        ...
        unicef_sectors = data.get("unicef_sector", [])
        data["unicef_leading_sector"] = None
        data["unicef_supporting_sectors"] = []
        if unicef_sectors:
            data["unicef_leading_sector"] = unicef_sectors[0]
            data["unicef_supporting_sectors"] = unicef_sectors[1:]
        return data
